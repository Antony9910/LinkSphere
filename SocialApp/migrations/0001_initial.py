# Generated by Django 5.0 on 2025-07-11 17:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PostUsers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_name', to='SocialApp.posts')),
            ],
        ),
        migrations.CreateModel(
            name='Stories',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.ManyToManyField(related_name='block_user', to='SocialApp.userprofile')),
